        ...
        if (error != 1){
            ...
            switch (token){
                ...
                default:
                    ...
                    if (yyleng > 100){
                        fprintf(stderr, "Error en linea %d, columna %d: identificador demasiado largo.\n", rows, columns);
                    } else {
                        fprintf(stderr, "Error en linea %d, columna %d: simbolo no permitido.\n", rows, columns);
                    }
                    break;
            }
        }
